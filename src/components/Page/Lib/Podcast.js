    ...
    <div className='podcast'>
      <div className='podcast__empty'>
        <div className='podcast__empty__box'>
          ...
          <h1 className='podcast__empty__header'>Theo dõi nghệ sĩ đầu tiên của bạn</h1>
          <p className='podcast__empty__text'>Theo dõi nghệ sĩ bạn yêu thích bằng cách nhấn vào nút theo dõi.</p>
          <Link to='/search' className='podcast__empty__btn' style={{textDecoration: 'none'}} onClick={() => setSearchValue('')}>Tìm nghệ sĩ</Link>
        </div>
        
        <div>
          <h4 className='body__content__item__title'>Podcast hàng đầu<button className='body__content__item__btn'>Xem tất cả</button></h4>
          <Grid container columns={16}>
            ...
            <Grid item xs={6} sm={3} md={2} className='body__content__item__box'>
              ...
              <p className='body__content__item__name'>Gen Z Tập Lớn</p>
              ...
              <p className='body__content__item__name'>BÁNH CAM & stories</p>

              <p className='body__content__item__description'>Bánh Cam nè</p>
              ...
              <p className='body__content__item__name'>Giang ơi Radio</p>

              <p className='body__content__item__description'>Giang ơi Radio</p>
