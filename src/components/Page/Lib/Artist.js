  ...
  return (
    ...
    {myArtist.length > 0 ? (
      <div className='playlist__box'>
        <h1 className='playlist__header'>My Artist</h1>
      ...
      <div className='artist__empty'>
        <div className='artist__empty__icon'>
          <svg role='img' height='64' width='64' viewBox='0 0 24 24' className="Svg-sc-1bi12j5-0 EQkJl">
        ...
        <h1 className='artist__empty__header'>Theo dõi nghệ sĩ đầu tiên của bạn</h1>
        <p className='artist__empty__text'>Theo dõi nghệ sĩ bạn yêu thích bằng cách nhấn vào nút theo dõi.</p>
        <Link to='/search' className='artist__empty__btn' style={{textDecoration: 'none'}} onClick={() => setSearchValue('')}>Tìm nghệ sĩ</Link>
      </div>
    )}
